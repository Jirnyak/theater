# 🔒 Security Policy — Jirnyak/theater
...
> Project Scope: `Theater Scenario Transition & Finite State Machine Engine`
...
We actively maintain and provide critical security updates for the following release lines of **Jirnyak/theater**:
...
Security engineering in Jirnyak/theater is guided by the following domain-specific threat vector analyses:

### 1. Deadlocked Scenario Graph
* **Description**: Unreachable state nodes trapping players in unresolvable story loops.
...
If you discover a security flaw or exploit vector in **Jirnyak/theater**, do **NOT** post it publicly in open issues or discussions.
